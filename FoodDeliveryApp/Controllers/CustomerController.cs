...
//This Controller is used to manage customer order interactions.
//It requires the customer to be logged in 
//([Authorize] or [Authorize(Roles=”Customer”)]). 
//It is used when the customer wants to place orders and view their order history
