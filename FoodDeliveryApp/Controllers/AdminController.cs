...
//This controller enables admins to manage orders and view products. 
//It requires an Admin role ([Authorize(Roles=”Admin”)]).
//It is used in the admin dashboard to manage orders and products.
